...
app.get(
  ...
  async (request, response) => {
     ...
     *
     FROM
     follower INNER JOIN tweet ON tweet.user_id = follower.following_user_id INNER JOIN like ON likes.tweet_id = tweet.tweet_id
...
app.get("/user/tweets/", authenticateToken, async (request, response) => {
  ...
  const getTweetsDetailsQuery = `
     ...
     tweet.date_time AS dateTime
     FROM 
     user INNER JOIN tweet ON user.user_id = tweet.user_id INNER JOIN like ON like.tweet_id = tweet.tweet_id INNER JOIN reply ON reply.tweet_id 
     WHERE 
